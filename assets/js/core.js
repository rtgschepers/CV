...
var Mi = {
    ...
    Basic: {
        ...
        scroller: function() {
            ...
            var $scrollers = $('#headers, #mobile-navs, [data-target="local-scroll"]');
        ...
        forms: function() {
            ...
            $contactForm.validate({
                ...
                messages: {
                    name: {
                        required    : "Voer alstublieft uw naam in.",
                        minlength   : "Uw naam dient minimaal 2 tekens te zijn."
                    },
                    email: {
                        required    : "Vul alstublieft uw emailadres in.",
                        minlength   : "U voerde een ongeldig emailadres in."
                    },
                    message: {
                        required    : "Vul alstublieft een bericht in.",
                        minlength   : "Uw bericht dient minimaal 10 tekens lang te zijn."
                    }
                }
            });
                ...
                if ($contactForm.valid()){
                    $.ajax({
                        ...
                        success: function(msg) {
                            if (msg === 'SEND') {
                                response = '<div class="alert alert-success">Verstuurd! Bedankt voor uw bericht - U zult zo snel mogelijk antwoord krijgen!';
                            }
                            else {
                                response = '<div class="alert alert-danger">Ooops... Er lijkt is mis te zijn gegaan.';
                            }
